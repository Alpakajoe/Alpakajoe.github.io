import * as HyperbolicOctahedron from './models/hyperbolicOctahedron.js';
import * as Torus from './models/torus.js';
import * as Sphere from './models/sphere.js'
import * as Plane from './models/plane.js';
import * as Enneper from './models/enneper.js';
import * as Snail from './models/snail.js';
...
var app = (function() {
    ...
    function initEventHandler() {
        ...
        increaseBtn.addEventListener('click', event => {
            stopEvent(event);
            changeRecursiveDepthValue(event, recursionDepth, true);
        }, false);

        decreaseBtn.addEventListener('click', event => {
            stopEvent(event);
            changeRecursiveDepthValue(event, recursionDepth, false);
        }, false);
    }
    ...
    function changeRecursiveDepthValue(event, currentRecursionDepth, ifIncrease) {
        let inputVal = currentRecursionDepth.value;
        const inputMin = currentRecursionDepth.min;
        const inputMax = currentRecursionDepth.max;
        if (inputVal !== null) {
            if (ifIncrease && inputVal != inputMax) {
                currentRecursionDepth.value = ++inputVal;
                start();
            } else if (!ifIncrease && inputVal != inputMin) {
                currentRecursionDepth.value = --inputVal;
                start();
            }
        }
